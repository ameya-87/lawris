...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-stone-50">
      {/* Left brand panel */}
      ...
      <main className="lg:col-span-7 xl:col-span-7 flex flex-col">
        {/* mobile brand strip */}
        <div className="lg:hidden flex items-center justify-between px-6 h-14 border-b border-stone-200 bg-white">
          <BrandMark tone="dark" size="sm" />
          <Link href="/sign-in" className="text-xs text-stone-500 hover:text-indigo-700">
            Help
          </Link>
        </div>
        ...
        <footer className="px-6 sm:px-10 py-4 text-xs text-stone-400 flex items-center justify-between">
